...
<link href="{{ asset('/public/front/css/font.css') }}" rel="stylesheet">
<link href="{{ asset('/public/front/css/font-awesome.css') }}" rel="stylesheet">
<link href="{{ asset('/public/front/css/heide-icon.css') }}" rel="stylesheet">
...
<script type="{{ asset('/public/front/js/jquery-1.11.3.min.js') }}"></script>
